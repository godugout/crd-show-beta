          ...
          <div className="relative z-10 h-full flex flex-col pointer-events-none">
            ...
            <div className="flex-1 flex items-start justify-center px-6 pt-32 hero-text-responsive transition-all duration-500">
              <div className="text-center space-y-4 max-w-4xl mx-auto">
                ...
                {/* Subtitle */}
                <p className="font-caveat text-2xl md:text-3xl text-crd-orange mb-6 max-w-2xl mx-auto leading-relaxed text-center">
          ...
          <div className="relative z-10 min-h-screen flex flex-col pointer-events-none">
            ...
            <div className="flex-1 flex items-start justify-center px-6 pt-40">
              <div className="text-center space-y-8 max-w-6xl mx-auto">
                ...
                {/* Subtitle */}
                <p className="font-caveat text-3xl md:text-4xl text-crd-orange mb-12 max-w-3xl mx-auto leading-relaxed text-center">
                  Transform your ideas into interactive 3D collectibles.
                </p>
